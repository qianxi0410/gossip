...
const components: Partial<Omit<NormalComponents, keyof SpecialComponents> & SpecialComponents> = {
  ...
  h2: properties => <h2 {...properties} className="text-2xl font-bold my-4" />,
  h3: properties => <h3 {...properties} className="text-xl font-bold my-3" />,
  h4: properties => <h4 {...properties} className="text-xl font-bold my-3" />,
  h5: properties => <h5 {...properties} className="text-xl font-bold my-2" />,
  h6: properties => <h6 {...properties} className="text-xl font-bold my-2" />,
  p: properties => <p {...properties} className="text-xl my-4" />,
  ...
  ul: properties => <ul {...properties} className="text-lg pl-5" />,
  ol: properties => <ol {...properties} className="text-lg list-decimal pl-5" />,
  li: properties => <li {...properties} className="text-lg my-2" />,
  table: properties => <table {...properties} className="w-4/5 text-lg border-b-1 bg-gray-50  mx-auto px-2 my-3" />,
